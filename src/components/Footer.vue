    ...
    <div class="container mx-auto max-w-5xl p-8">
      <nav class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
        <ul class="flex flex-col text-left">
          <h6 class="text-md font-bold text-gray-800 pb-2">User Portal</h6>
          <RouterLink to="/login" class="dark:text-neutral-500 hover:text-blue-600 hover:underline">
            Login
          </RouterLink>
          <RouterLink to="/register" class="dark:text-neutral-500 hover:text-blue-600 hover:underline">
            Register
          </RouterLink>
        </ul>

        <ul class="flex flex-col text-left">
          <h6 class="text-md font-bold text-gray-800 pb-1">PDF Extract</h6>
          <RouterLink to="/blog" class="text-neutral-900 dark:text-neutral-500 hover:text-blue-600 hover:underline">
            Blog
          </RouterLink>
          <RouterLink to="/" class="text-neutral-900 dark:text-neutral-500 hover:text-blue-600 hover:underline">
            Home
          </RouterLink>
        </ul>

        <ul class="flex flex-col text-left">
          <h6 class="text-md font-bold text-gray-800 pb-2">Support</h6>
          <RouterLink to="/help" class="text-neutral-900 dark:text-neutral-500 hover:text-blue-600 hover:underline">Help
          </RouterLink>
        </ul>
        <span>
