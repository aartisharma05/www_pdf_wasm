...
<template class="flex flex-col min-h-screen">
    ...
    <div class="container mx-auto bg-fixed max-w-5xl py-4 px-8">
      <div class="flex justify-between">
        ...
        <button
          ...
          class="block sm:hidden p-1 m-1 rounded focus:outline-none hover:bg-gray-100 group"
  ...
  <footer
    class="bg-neutral-200 text-center dark:bg-neutral-700 lg:text-center fixed bottom-0 w-full"
  >
    <div class="p-4 text-center text-neutral-700 dark:text-neutral-200">
      <p class="text-neutral-800 dark:text-neutral-400">© 2023 Copyright: Vijay Anand</p>
    </div>
  </footer>
</template>
